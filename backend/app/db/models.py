...
class Services(Base):
    ...
    __table_args__ = (PrimaryKeyConstraint("id", name="services_pkey"),)
    ...
    configs: Mapped[List["Configs"]] = relationship(
        "Configs", back_populates="services"
    )
...
class UsersRoutes(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["user_id"], ["users.id"], name="users_routes_users_id_fk"
        ),
        ForeignKeyConstraint(
            ["route_id"], ["routes.id"], name="users_routes_routes_id_fk"
        ),
...
class Configs(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["service"], ["services.id"], name="configs_services_serviceid_fk"
        ),
        ForeignKeyConstraint(
            ["owner"], ["users.id"], name="configs_services_userid_fk"
        ),
    ...
    stations: Mapped[List["Stations"]] = relationship(
        "Stations", back_populates="configs"
    )
